...
export default async function EditProductoPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [producto, options] = await Promise.all([getProductoById(id), getProductoFormOptions()]);
